...
@Kroll.module(name="Pressure", id="com.francisco.pressure")
public class PressureModule extends KrollModule implements SensorEventListener
{
private static final String EVENT_UPDATE = "update";
		...
		KrollRuntime.addOnDisposingListener(new KrollRuntime.OnDisposingListener() {
			...
			public void onDisposing(KrollRuntime runtime)
			{
				...
				if (pressureRegistered) {
					TiSensorHelper.unregisterListener(Sensor.TYPE_PRESSURE, PressureModule.this);
	...
	public void onSensorChanged(SensorEvent event)
	{
		...
		if (event.timestamp - lastSensorEventTimestamp > 100) {
			...
			data.put("pressure", event.values);
	...
	{
		return "Francisco.PressureModule";
	}

	/**
	* Francisco's barometer
	*
	*/
