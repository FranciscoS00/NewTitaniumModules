	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"com.francisco.magnetometer.MagnetometerModule", ::com::francisco::magnetometer::MagnetometerModule::bindProxy, ::com::francisco::magnetometer::MagnetometerModule::dispose}
			};
